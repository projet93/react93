...
export const ReferentDeleteDialog = (props: IReferentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="react93App.referent.delete.question">
        <Translate contentKey="react93App.referent.delete.question" interpolate={{ id: referentEntity.id }}>
          Are you sure you want to delete this Referent?
        </Translate>
      </ModalBody>
      <ModalFooter>
